...
#11  DEBUG = os.getenv('DEBUG') == 'True'  # Convert string to boolean
...
SECRET_KEY = 'django-insecure-!b!0x3@ddcewe$$f=&n#x68m8e2gvtu=0!(&4%52b(&b%6hxu+'
...
DATABASES = {
    'default': env.db("DATABASE_URL")  # automatically parses the connection string
}
CONN_MAX_AGE = 0 
